...
<template>
  <div id="contact-info-main" class="contact-info">
    ...
    <div id="social-icons" class="social-section">
      ...
      <a href="https://github.com/Carlosdvp" target="_blank">
        <svg class="icon-github"><use xlink:href="#icon-github"></use>
      ...
      <a href="https://www.linkedin.com/in/carlosdv/" target="_blank">
        <svg class="icon-linkedin" role="img" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
...
.contact-info {
  border-top: 2px solid rgba(19, 20, 21, .85);
/*   text-align: center; */
  display: grid;
...
.contact-title {
  grid-area: header;
  border-bottom: 2px solid rgba(32, 84, 135, .85);
  padding-bottom: .4em;
  font-weight: bold;
  font-size: 2em;
}
