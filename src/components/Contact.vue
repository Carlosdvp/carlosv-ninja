...
<template>
  <div
    ...
    class="mt-auto grid contact-info grid-cols-[20%,30%,30%,20%] grid-rows-[30%,50%,20%] border-t-2 border-slate-600">

    <div
      class="border-b-2 border-blue-600 py-2 font-bold text-3xl contact-title">
      <h3> &mdash; Contact &mdash;</h3>
    </div>

    <div
      class="social-section grid grid-cols-[33%,33%,33%] py-8">
      <a
        href="mailto:carlosdvp@yahoo.com?subject=Información%20sobre%20servicios" target="_blank"
        class="justify-self-center">
        <svg
          class="text-5xl icon-mail hover:text-white">
      ...
      <a
        ...
        class="justify-self-center">
        <svg
          class="text-5xl icon-github hover:text-white">
      ...
      <a
        href="https://www.linkedin.com/in/carlosdv/"
        target="_blank"
        class="justify-self-center">
        <svg
          class="text-5xl icon-linkedin hover:text-white"
          role="img"
          viewBox="0 0 24 24"
